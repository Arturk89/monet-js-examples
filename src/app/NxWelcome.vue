    ...
    <div class="container">
      ...
      <div id="middle-content">
        ...
        <div id="other-links">
          ...
          <div id="nx-cloud" class="rounded shadow">
            ...
            <a
              href="https://cloud.nx.app/connect/rSTXMgnQc7"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div id="commands" class="rounded shadow">
        ...
        <details>
          ...
          <pre><span># Build</span>nx build<span># Test</span>nx test
<span># Lint</span>nx lint
<span># Run them together!</span>nx run-many -t build test lint </pre>
        </details>
        <details>
          <summary>
            <svg
